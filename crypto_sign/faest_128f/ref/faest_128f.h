...
#define FAEST_128F_SIGNATURE_SIZE 6336
 ...
 */
FAEST_EXPORT int FAEST_CALLING_CONVENTION faest_128f_keygen(uint8_t* pk, uint8_t* sk);
 ...
 * bytes required for a parameter set is given by 128f_signature_size().
 ...
 */
FAEST_EXPORT int FAEST_CALLING_CONVENTION faest_128f_sign(const uint8_t* sk, const uint8_t* message, size_t message_len, uint8_t* signature, size_t* signature_len);
 ...
 * @see faest_verify(), faest_keygen(), faest_signature_size()
 */
FAEST_EXPORT int FAEST_CALLING_CONVENTION faest_128f_sign_with_randomness(const uint8_t* sk, const uint8_t* message, size_t message_len, const uint8_t* rho, size_t rho_len, uint8_t* signature, size_t* signature_len);
 ...
 */
FAEST_EXPORT int FAEST_CALLING_CONVENTION faest_128f_verify(const uint8_t* pk, const uint8_t* message, size_t message_len, const uint8_t* signature, size_t signature_len);
 ...
 */
FAEST_EXPORT int FAEST_CALLING_CONVENTION faest_128f_validate_keypair(const uint8_t* pk, const uint8_t* sk);
 ...
 */
FAEST_EXPORT void FAEST_CALLING_CONVENTION faest_128f_clear_private_key(uint8_t* key);
