...
#define FAEST_192S_PUBLIC_KEY_SIZE 64
#define FAEST_192S_PRIVATE_KEY_SIZE 56
#define FAEST_192S_SIGNATURE_SIZE 12744
 ...
 * bytes required for a parameter set is given by 192s_signature_size().
