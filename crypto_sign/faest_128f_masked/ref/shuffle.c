...
void byte_combine_bits_shuffle_6(uint8_t* decoy_in, bf128_t* decoy_out, const uint8_t* real_k, const uint8_t* real_v_w, bf128_t* k_out, bf128_t* v_w_out) {
    ...
    *out_places[0] = bf128_byte_combine_bits(*in_places[0]);
    *out_places[1] = bf128_byte_combine_bits(*in_places[1]);
    *out_places[2] = bf128_byte_combine_bits(*in_places[2]);
    *out_places[3] = bf128_byte_combine_bits(*in_places[3]);
    *out_places[4] = bf128_byte_combine_bits(*in_places[4]);
    *out_places[5] = bf128_byte_combine_bits(*in_places[5]);
}
...
void byte_combine_bits_shuffle_11(uint8_t* decoy_in, bf128_t* decoy_out, const uint8_t* real_k, const uint8_t* real_v_w, bf128_t* k_out, bf128_t* v_w_out) {
    ...
    *out_places[4] = bf128_byte_combine_bits(*in_places[4]);
    *out_places[5] = bf128_byte_combine_bits(*in_places[5]);
    *out_places[6] = bf128_byte_combine_bits(*in_places[6]);
    *out_places[7] = bf128_byte_combine_bits(*in_places[7]);
    *out_places[8] = bf128_byte_combine_bits(*in_places[8]);
    *out_places[9] = bf128_byte_combine_bits(*in_places[9]);
    *out_places[10] = bf128_byte_combine_bits(*in_places[10]);
}