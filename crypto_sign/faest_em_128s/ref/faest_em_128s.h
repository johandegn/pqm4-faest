...
#ifndef FAEST_EM_128S_H
#define FAEST_EM_128S_H
...
#define FAEST_EM_128S_SIGNATURE_SIZE 4566
 ...
 */
FAEST_EXPORT int FAEST_CALLING_CONVENTION faest_em_128s_keygen(uint8_t* pk, uint8_t* sk);
 ...
 * bytes required for a parameter set is given by em_128s_signature_size().
 ...
 */
FAEST_EXPORT int FAEST_CALLING_CONVENTION faest_em_128s_sign(const uint8_t* sk, const uint8_t* message, size_t message_len, uint8_t* signature, size_t* signature_len);
 ...
 * @see faest_verify(), faest_keygen(), faest_signature_size()
 */
FAEST_EXPORT int FAEST_CALLING_CONVENTION faest_em_128s_sign_with_randomness(const uint8_t* sk, const uint8_t* message, size_t message_len, const uint8_t* rho, size_t rho_len, uint8_t* signature, size_t* signature_len);
 ...
 */
FAEST_EXPORT int FAEST_CALLING_CONVENTION faest_em_128s_verify(const uint8_t* pk, const uint8_t* message, size_t message_len, const uint8_t* signature, size_t signature_len);
 ...
 */
FAEST_EXPORT int FAEST_CALLING_CONVENTION faest_em_128s_validate_keypair(const uint8_t* pk, const uint8_t* sk);
 ...
 */
FAEST_EXPORT void FAEST_CALLING_CONVENTION faest_em_128s_clear_private_key(uint8_t* key);
